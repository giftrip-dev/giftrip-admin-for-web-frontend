    ...
    <div className="relative inset-0 z-50 min-h-screen">
      ...
      <div className="mx-auto mt-[120px] flex max-w-[800px] flex-col items-center justify-center gap-5 py-10">
        <div className="">
          ...
          <br />
          <br />
          &ldquo;기프트립(GIFTRIP)&rdquo;(이하 &ldquo;회사&rdquo;)는
          &ldquo;정보통신망 이용촉진 및 정보보호에 관한 법률&rdquo;,
          &ldquo;개인정보보호법&rdquo;, &ldquo;통신비밀보호법&rdquo;,
          &ldquo;전기통신사업법&rdquo; 및 &ldquo;전자상거래 등에서의 소비자
          보호에 관한 법률&rdquo; 등 정보통신서비스제공자가 준수하여야 할 관련
          법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한
          개인정보처리방침을 정하여 이용자 권익 보호에 최선을 다하겠습니다.
          &ldquo;회사&rdquo;는 이용자의 개인정보를 [개인정보의 수집목적]에서
          고지한 범위 내에서 사용하며, 이용자의 사전 동의 없이는 동 범위를
          초과하여 이용하거나 원칙적으로 이용자의 개인정보를 외부에 제공 또는
          ...
          따라 수사기관의 요구가 있는 경우
          <br />
          - 이러한 경우에도, &ldquo;회사&rdquo;는 이용자에게 (1)개인정보를
          제공받는 자 (2)그의 이용목적 (3)개인정보의 보유 및 이용기간을 사전에
          고지하고 이에 대해 명시적 개별적으로 동의를 얻습니다. 이와 같은 모든
          과정에 있어서 회사는 이용자의 의사에 반하여 추가적인 정보를
          수집하거나, 동의의 범위를 벗어난 정보를 제3자와 공유하지 않습니다.
          <br />
          <br />
          <span className="font-semibold">[개인정보 활용처]</span>
          <br />
          <br />
          &ldquo;기프트립&rdquo;은 아래와 같은 활용 목적을 가지고 이용자
          개인정보를 수집합니다.
          <br />
          <br />
          ...
          8. 법령 등에 규정된 의무의 이행
          <br />
          9. 법령이나 이용약관에 반하여 여러분에게 피해를 줄 수 있는 잘못된
          이용행위의 방지
          <br />
          <br />
          <span className="font-semibold">[수집하는 개인정보]</span>
          <br />
          <br />
          1. 거래 계좌번호
          <br />
          ...
          <br />
          8. 이름, 휴대폰 번호, 주소, 결제, 취소, 환불과 같은 개인정보
          <br />
          9. 서비스 이용과정에서 이용자가 작성하는 게시물 기타 콘텐츠 등 정보,
          사용하는 기능, 수행하는 행동이나 활동 시간, 빈도 및 기간 등<br />
          <br />
          <span className="font-semibold">[개인정보를 수집하는 방법]</span>
          <br />
          <br />
          &ldquo;기프트립&rdquo;은 다음과 같은 방법을 통해 개인정보를
          수집합니다.
          <br />
          <br />
          ...
          <span className="font-semibold">
            [서비스 비용 과정에서 이용자로부터 수집하는 개인정보]
          </span>
          <br />
          <br />
          PC웹, 모바일 웹/앱 이용 과정에서 단말기정보(OS, 화면사이즈, 디바이스
          아이디), IP주소, 쿠키 정보, 방문일시의 정보가 자동으로 생성되어 수집될
          수 있습니다.
          <br />
          <br />
          <span className="font-semibold">[개인정보 공유 및 제공]</span>
          <br />
          <br />
          &ldquo;기프트립&rdquo;은 이용자가 서비스 이용과정 등에서 따로 동의하는
          경우나 법령에 규정된 경우를 제외하고는 이용자 개인정보를 위에서 말씀
          드린 목적 범위를 초과하여 이용하거나 제3장에게 제공 또는 공유하지
          않습니다.
          <br />
          <br />
          <span className="font-semibold">[개인정보 처리 위탁]</span>
          <br />
          <br />
          &ldquo;기프트립&rdquo;은 서비스의 원활한 제공을 위해 필요한 때에는
          개인정보의 처리를 일부 위탁하고 있으며, 수탁 받은 업체가 관계 법령을
          준수하도록 관리·감독하고 있습니다.
          <br />
          <br />
          <span className="font-semibold">
          ...
          때에는 회사 내부 방침 또는 관계 법령에서 정한 일정한 기간 동안 보관한
          다음 파기합니다. 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을
          통하여 파기하고, 전자적 파일 형태로 저장된 개인정보는 기록을 재생할 수
          없는 기술적 방법을 사용하여 삭제합니다. &ldquo;기프트립&rdquo;의 내부
          방침 또는 법령에 따라 보관하는 개인정보 및 해당 법령은 하기의 표와
          같습니다. 또한 아래 기준과 별개로 &ldquo;회사&rdquo;는 1년간 서비스를
          이용하지 않은 회원의 개인정보를 별도로 분리 보관 또는 삭제하고 있으며,
          분리 보관된 개인정보는 4년간 보관 후 지체없이 파기합니다.
          &lsquo;이용목적이 달성된 때&rsquo;란 철회요청, 서비스계약 만료, 탈퇴
          시를 의미합니다.
          <br />
          <br />
          ...
          <br />
          <span className="font-semibold">
            [인터넷 접속 정보파일 등 개인정보를 자동으로 수집하는 장치의
            설치·운영 및 그 거부에 관한 사항]
          </span>
          <br />
          <br />
          ...
          이용자가 웹사이트를 방문할 때, 웹 사이트 사용을 설정한대로 접속하고
          ...
          옵션 &gt; 개인정보 &gt; 설정
          <br />
          - Chrome의 경우 웹 브라우저 우측의 설정 메뉴 &gt;화면 하단의 고급 설정
          표시 &gt; 개인정보의 콘텐츠 설정 버튼 &gt; 쿠키
          <br />
          <br />
          이용자 권리 보호
          <br />
          <br />
          이용자(만 14세 미만인 경우 법정 대리인)는 언제든지 이용자 개인정보를
          조회하거나 수정할 수 있으며, 수집·이용에 대한 동의 철회 또는 가입
          해지를 요청할 수도 있습니다. 보다 구체적으로는 서비스 내 설정 기능을
          통한 변경, 가입 해지(동의 철회)를 위해서는 서비스 내 &lsquo;계정
          탈퇴&rsquo;를 클릭하면 되며, 운영자에게 이메일이나 별도 게시판으로
          문의할 경우에도 지체 없이 조치하겠습니다.
          <br />
          <br />
          개인정보 문의처
          <br />
          ...
          주시기 바랍니다. &ldquo;기프트립&rdquo;은 사용자의 목소리에 귀
          ...
          - 직위 : 실장
          <br />
          - 연락처 : danjae@peachcorp.co.kr
          <br />
          <br />
          고지의무
          <br />
          <br />
          &ldquo;기프트립&rdquo;은 법률이나 서비스의 변경사항을 반영하기 위한
          목적 등으로 개인정보처리방침을 수정할 수 있습니다. 개인정보처리방침이
          변경되는 경우 &ldquo;기프트립&rdquo;은 변경 사항을 게시하며, 변경된
          개인정보처리방침은 게시한 날로부터 7일 후부터 효력이 발생됩니다.
          <br />
          <br />
          권익침해 구제방법
          <br />
          <br />
          하기의 기관은 별개의 기관으로서, &ldquo;기프트립&rdquo;의 자체적인
