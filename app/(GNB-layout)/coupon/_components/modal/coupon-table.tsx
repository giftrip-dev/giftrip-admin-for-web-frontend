...
interface CouponTableProps {
  ...
  setSelectedCouponId: React.Dispatch<React.SetStateAction<string | null>>; // 쿠폰 선택 핸들러
...
export function CouponTable({
        ...
        >
          <input
            ...
            onChange={() => {
              ...
              setSelectedCoupon(data.row.original);
            }}
            className="size-4"
          />
        </div>
  ...
  }, [selectedCouponId, setSelectedCouponId, setSelectedCoupon, columnHelper]);
