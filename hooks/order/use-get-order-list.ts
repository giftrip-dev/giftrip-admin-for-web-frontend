...
export const useGetOrderList = (params: OrderPaginationReq) => {
  ...
  const trimmedParams = {
    ...
    createdAtEnd: params.createdAtEnd
      ...
      : undefined,
    deliveryStatus:
      params.deliveryStatus === "all" ? undefined : params.deliveryStatus,
  };

  const key = ["/orders", trimmedParams] as const;
